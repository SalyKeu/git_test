...
function ServicesModal({ onClose }) {
  const { setAddBooking,setPrice, setName,setDuration } = useModal();
  const handleBooking = () => {
    setAddBooking(true);
    setName("Lash Lift + Tint");
    setDuration("45 mins - 1 hr");
    setPrice("$40");
    onClose();
  };
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
            ...
            <div className='flex justify-between mt-4'>
                ...
                transition duration-300 font-bold shadow-md -mt-5 hidden md:inline-block md:ml-auto mr-6'
