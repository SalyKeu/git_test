      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
        <div className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-2xl">
          <div className="flex items-start justify-between gap-4">
            <h2 className="text-xl font-semibold">Lash Lift + Tint</h2>
            <button
              type="button"
              onClick={onClose}
          ...
          <p className="mt-3 text-gray-600">
            Elevate your natural beauty with our Lash Lift and Tint service.
            This transformative treatment enhances your lashes, giving them a
            gorgeous, lifted appearance while adding depth and richness with a
            custom tint. Enjoy beautifully curled, defined lashes that lasts up
            to 6-8 weeks—perfect for those who want to wake up ready to go!
          </p>
          <div className="flex justify-between mt-4">
            ...
            <button
              ...
              className={`font-serif rounded-lg p-3 bg-linear-to-r from-pink-400 to-pink-300 
