...
function NavBar() {
  ...
  return (
    <>
      <div>
        <nav className="fixed top-0 left-0 w-full flex items-center justify-between bg-white/40 backdrop-blur-2xl z-50">
          <div className="flex flex-row justify-start items-center w-full md:px-4 py-2 ">
            ...
            <div className="hidden md:flex md:ml-8 gap-6">
              <ul className="flex gap-6 text-lg">
                <Link
                  to="/"
                  className="hover:text-pink-500 font-serif hover:cursor-pointer"
                >
                  Home
                </Link>
                <Link
